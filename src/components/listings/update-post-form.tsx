          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
             <FormItem>
                ...
                <div className="aspect-video w-full overflow-hidden rounded-lg border">
                 ...
                 <FormDescription>
                    The image is generated by AI based on the title. To change the image, please create a new listing.
                 </FormDescription>
            </FormItem>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    The title cannot be changed as it is used for image generation.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Describe your item, service, or announcement in detail."
